...
csl: ama.csl
geometry: [top=1in, bottom=1in, right=1.5in, left=2in]
linestretch: 1.5
fontsize: 12pt
---
...
## Overall table 
In that table, a descriptive statistics of all variables is shown. This table gives me a overall idea of the dataset.
...
kbl(registration,caption = "Completeness of Registration Number" , align = "c") %>%
  ...
  collapse_rows(columns = 1:2, valign = "middle")%>% kable_styling(latex_options = "hold_position",font_size = 12 )
...
\newpage
## Quality of care 
This tables gives an overview whether register system has benefit or not.
...
## Adoption table
There are 12 questions in the register system those are must fill up questions.This table shows an overview how much these questions are filled up by the nurses. 
...
kbl(cbc,caption ="Accuracy of CBC and Electrolyte" , align = "c") %>%
  ...
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1:2, valign = "middle") %>% 
  add_header_above(c(" "," ", "CBC" = 2, "Electrolyte" = 2))%>%  kable_styling(latex_options = "hold_position", font_size = 12)
...
kbl(blood,caption ="Accuracy of Blood Suger and Chest X-ray" , align = "c") %>%
  ...
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1:2, valign = "middle") %>% 
  add_header_above(c(" "," ", "Blood Suger" = 2, "Chest X-ray" = 2))%>%  kable_styling(latex_options = "hold_position", font_size = 12)
...
kbl(oxy, caption ="Accuracy of Oxygen and IV fluid" ,align = "c") %>%
  ...
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1:2, valign = "middle") %>% 
  add_header_above(c(" "," ", "Oxygen" = 2, "IV fluid" = 2))%>% kable_styling(latex_options = "hold_position", font_size = 12)
...
kbl(inj,caption ="Accuracy of Injectable antibiotics and Inj Ampicilin" , align = "c") %>%
  ...
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1:2, valign = "middle") %>% 
  add_header_above(c(" "," ", "Injectable antibiotics	" = 2, "Inj Ampicilin	" = 2))%>%  kable_styling(latex_options = "hold_position", font_size = 12)
...
kbl(gen,caption ="Accuracy of Inj Gentamicin and Inj Ceftriaxone" , align = "c") %>%
  ...
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1:2, valign = "middle") %>% 
  add_header_above(c(" "," ", "Inj Gentamicin	" = 2, "Inj Ceftriaxone	" = 2))%>%  kable_styling(latex_options = "hold_position", font_size = 12)
...
kbl(newb,caption ="Accuracy of Newborn Sepsis and Birth Asphyxia" , align = "c") %>%
  ...
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1:2, valign = "middle") %>% 
  add_header_above(c(" "," ", "Newborn Sepsis	" = 2, "Birth Asphyxia" = 2))%>% kable_styling(latex_options = "hold_position", font_size = 12)
...
kbl(ref,caption = "Accuracy of Prematurity and LBW and Severe Pneumonia", align = "c") %>%
  ...
  column_spec(1, bold = T) %>%
  collapse_rows(columns = 1:2, valign = "middle") %>% 
  add_header_above(c(" "," ", "Prematurity and LBW" = 2, "Severe Pneumonia" = 2,"Refer	" = 2))%>% kable_styling(latex_options = "hold_position", font_size = 9)
